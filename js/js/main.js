...
window.addEventListener('load', () => {
    ...
    // Tidak ada initDraggableWA() karena fitur drag dihapus
...
// PRELOAD IMAGE UNTUK ANIMASI LOGO SMOOTH
const webLogoImage = new Image();
webLogoImage.src = 'img/logo_web.png';
...
// FIX: ANIMASI LOGO YANG LEBIH ROBUST
...
if(menuBtn) {
    menuBtn.addEventListener('click', () => {
        ...
        if (logoImg) {
            ...
            // 2. Ganti source
            setTimeout(() => {
                // Gunakan pengecekan classList pada mainHeader atau navOverlay
                if (mainHeader.classList.contains('menu-active')) {
            ...
            }, 300); // 300ms sesuai durasi CSS transition
        }
    });
}
